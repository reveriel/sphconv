...
struct DefaultMma<ElementA, LayoutA, kAlignmentA, ElementB, LayoutB,
                  ...
                  InstructionShape, 2, Operator, AccumulatorsInRowMajor, reverseRule> {
    ...
    using IteratorA =
        sphconv::threadblock::InputTileIterator<
            ElementA, IteratorThreadMapA, kAlignmentA, reverseRule>;
...
template <
    ...
    /// Operation performed by GEMM
    typename Operator>
struct DefaultMmaDW<ElementA, LayoutA, kAlignmentA, ElementB, LayoutB,
                  kAlignmentB, ElementAccumulator, LayoutC,
                  cutlass::arch::OpClassSimt, ArchTag, ThreadblockShape, WarpShape,
    ...
    using IteratorA =
        sphconv::threadblock::InputTileIterator<
            ElementA, IteratorThreadMapA, kAlignmentA, 0, true, 0>; // transposed
    ...
    using IteratorB =
        sphconv::threadblock::InputTileIterator<
            ElementB, IteratorThreadMapB, kAlignmentB, 1, false, 0>;
